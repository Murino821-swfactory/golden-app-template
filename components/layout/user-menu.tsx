...
export function UserMenu() {
  ...
  // Both destinations exist once per language, so the links have to carry the one on
  // screen — a Slovak visitor sent to the default locale's /login loses their language.
