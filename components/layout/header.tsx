 ...
 *
 * Contents are deliberately three controls and a name — language, palette and sign-in.
 * The language switcher renders only when the prototype has more than one language. No
 * nav: a prototype has two or three routes, and a menu over them is chrome pretending to
 * be a product.
 *
